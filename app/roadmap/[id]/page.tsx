    ...
    return (
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ textAlign: "center", padding: 24 }}>
          ...
          <Link href="/roadmaps" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "10px 20px", borderRadius: 12, background: "var(--accent)", color: "white", fontSize: 14, fontWeight: 500, textDecoration: "none" }}>
            Browse all roadmaps
          </Link>
        </div>
      </div>
  ...
  return (
    <div style={{ minHeight: "100vh" }}>
        ...
        <div style={{ ...container, padding: "48px 24px" }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: 20, marginBottom: 20 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <h1 style={{ fontSize: 32, fontWeight: 900, letterSpacing: "-0.02em", marginBottom: 8 }}>{roadmap.title}</h1>
                ...
                <div style={{ flex: 1, minWidth: 0, paddingBottom: 24 }}>
                  <button onClick={() => setExpanded(isOpen ? null : step.id)} style={{ width: "100%", textAlign: "left", background: "none", border: "none", padding: 0, cursor: "pointer" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "4px 0" }}>
                      <h3 style={{ fontSize: 16, fontWeight: 600, color: done ? "var(--success)" : "var(--foreground)", textDecoration: done ? "line-through" : "none", textDecorationColor: done ? "color-mix(in srgb, var(--success) 40%, transparent)" : "transparent", margin: 0 }}>
                        {step.label}
                      </h3>
      ...
      <footer style={{ background: "var(--background)" }}>
        <div style={{ maxWidth: 768, margin: "0 auto", padding: "40px 24px", display: "flex", flexDirection: "row", flexWrap: "wrap", alignItems: "center", justifyContent: "center", gap: 8 }}>
