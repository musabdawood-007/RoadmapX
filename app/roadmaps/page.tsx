  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      ...
      <div style={{ borderBottom: "1px solid var(--card-border)" }}>
        <div className="container-px" style={{ ...container, padding: "40px 24px" }}>
      ...
      <div className="container-px" style={{ ...container, padding: "28px 24px 80px" }}>
        {/* Filters */}
        ...
        {/* Grid */}
        <div className="stagger-children grid-3" style={{ gap: 16 }}>
          {filtered.map((r) => (
        ...
        {filtered.length === 0 && (
          <div style={{ textAlign: "center", padding: "72px 0" }}>
            <h3 style={{ fontSize: 17, fontWeight: 600, marginBottom: 8 }}>No roadmaps found</h3>
            <p style={{ fontSize: 14, color: "var(--muted)", marginBottom: 20, maxWidth: 380, margin: "0 auto 20px", lineHeight: 1.6 }}>
      ...
      <footer style={{ background: "var(--background)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "32px 24px", display: "flex", flexDirection: "row", flexWrap: "wrap", alignItems: "center", justifyContent: "center", gap: 8 }}>
